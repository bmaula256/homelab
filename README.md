...
- **truenas**: Currently the only service run outside of my proxmox, my homelab consists of a two-pronged setup, the proxmox with all the containers and virtual machines, and a seperate TrueNAS SCALE box for all my storage needs. Currently hosts a variety of NFS shares for whatever services in VLAN 100 need them.

### VLAN 101
This VLAN contains all/most of the endpoints that do not require direct access to the storage server or any adjacent services. This is done because my proxmox management interface lives on VLAN 100, and I wanted to reduce the risk as stated above.
